...
@Component({
  selector: 'app-create-task-mat-field',
  templateUrl: './create-task-mat-field.component.html',
  styleUrls: ['./create-task-mat-field.component.css'],
  encapsulation: ViewEncapsulation.None  // Try changing this to Non
})
export class CreateTaskMatFieldComponent {
